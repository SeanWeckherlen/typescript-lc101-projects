...
var hourToMars = milesToMars / speedMph;
var daysToMars = hourToMars / 24;
var outputString = spacecraftName + " will take " + daysToMars + " days to get to Mars.";
...
var outputStringMars = spacecraftName + " will take " + getDaysToLocation(kilometersToMars) + " days to get to Mars.";
//console.log(outputStringMars);
var outputStringMoon = spacecraftName + " will take " + getDaysToLocation(kilometersToTheMoon) + " days to get to the moon.";
